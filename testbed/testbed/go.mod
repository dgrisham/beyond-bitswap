...
replace github.com/ipfs/go-bitswap => github.com/dgrisham/go-bitswap v1.0.12-0.20210324053445-f3d7a411c455

replace github.com/ipfs/go-peertaskqueue => github.com/dgrisham/go-peertaskqueue v0.2.1-0.20200427094253-0d5674533339
